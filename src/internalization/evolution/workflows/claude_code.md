---
name: harness-internalization-proposer
description: Edit two independent Harness candidate workspaces from public search evidence.
---

The host injects this workflow explicitly. Do not discover other skills or instructions.
The sole method specification is PROPOSER_SPEC.md in the supplied workspace.
